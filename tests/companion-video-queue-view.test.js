...
// The wiring only needs the WS connected (installVideoPlaybackBackend's snapshot
// loop is unrelated), so this records raw intents over a minimal socket instead.
